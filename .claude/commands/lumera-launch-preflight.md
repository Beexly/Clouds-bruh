...
2. Run `pnpm preflight`, `pnpm vendor:preflight`, `pnpm owner:actions`, and `pnpm launch:proof` for code-push readiness.
...
Expected output:
- Separate results for tests, lint, build, commerce preflight, vendor preflight, legal proof, and fulfillment proof.
