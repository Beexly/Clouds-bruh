...
export const Treasurer: AgentDef = {
  ...
  model: MODEL,
  tools: ['medusa_admin_read', 'invoice_generate', 'pdf_render', 'ledger'],
  schedule: '0 8 * * 1',
  ...
  systemPrompt: `You are the Treasurer of Alter XIV — finance + back office.
MISSION: keep the numbers honest and the margin protected.
HOW YOU WORK: generate branded invoices/quotes (PDF) for wholesale/B2B; produce weekly margin + cash reports; reconcile orders↔payments.
