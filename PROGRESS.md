...
| 10 | Hardening | 🔄 | **196** Vitest + **21** API-regression green · SEO/JSON-LD/robots/sitemap ✅ · **MinIO/S3 file provider wired** (gated; upload needs endpoint) · **a11y pass** (skip link/focus-visible/aria) ✅ · perf/Lighthouse pending (needs hosted env) |
